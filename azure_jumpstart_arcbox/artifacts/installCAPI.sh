...
sudo curl -o /etc/profile.d/welcomeCAPI.sh https://raw.githubusercontent.com/microsoft/azure_arc/capi_kustomize/azure_jumpstart_arcbox/artifacts/welcomeCAPI.sh
