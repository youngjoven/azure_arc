...
sudo curl -o /etc/profile.d/welcomeK3s.sh https://raw.githubusercontent.com/microsoft/azure_arc/capi_kustomize/azure_jumpstart_arcbox/artifacts/welcomeK3s.sh
